...
var handlers = {
    'source-file':{
        install:function(obj, plugin, project, options) {
            ...
            if (!obj.targetDir) {
              throw new CordovaError('<source-file> element is missing "target-dir" attribute for plugin: ' + plugin.id);
              //We should be able to get the namespace from the plugin ID
            }
