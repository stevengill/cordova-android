...
function AndroidProject(projectDir) {
    ...
    this.www = path.join(this.projectDir, 'main/src/main/assets/www');
}
...
AndroidProject.prototype.getPackageName = function() {
    return new AndroidManifest(path.join(this.projectDir, 'app', 'src', 'main', 'AndroidManifest.xml')).getPackageId();
};
